...
class CreatePost extends Component
{
    ...
    protected $rules =[
        'nombre' => 'required|unique:discounts,name|max:30|alpha_num',
        'prioridad' => 'required|numeric|max:100|min:1',
        'desde' => 'required|numeric|',
        'hasta' => 'required|numeric|gt:desde',
        'codigo' => 'alpha_num|required_without:descuento',
        'descuento' => 'numeric|required_without:codigo',
        'desde2' => 'required|numeric|',
        'hasta2' => 'required|numeric|gt:desde2',
        'codigo2' => 'alpha_num|required_without:descuento2',
        'descuento2' => 'numeric|required_without:codigo2',
        'desde3' => 'required|numeric|',
        'hasta3' => 'required|numeric|gt:desde3',
        'codigo3' => 'alpha_num|required_without:descuento3',
        'descuento3' => 'numeric|required_without:codigo3',
        'desdeGeneral' => 'required',
        'hastaGeneral' => 'required',
        'completo' => 'confirmed,desde|confirmed,hasta',
    ];
    ...
    public function render()
    {
        ...
        return view('livewire.create-post', compact('regions', 'brands', 'access'));
    }
